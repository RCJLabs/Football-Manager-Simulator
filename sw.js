...
const SHELL = [
  ...
  './src/engine/stats.js', './src/engine/draft.js', './src/engine/season.js', './src/engine/auction.js', './src/engine/transactions.js', './src/engine/injuries.js', './src/engine/offseason.js', './src/engine/penalties.js', './src/engine/winprob.js', './src/engine/clinch.js', './src/ui/charts.js', './src/engine/awards.js', './src/ui/views/awards.js', './src/engine/gm.js', './src/engine/result.js', './src/engine/rookies.js', './src/engine/autosim.js', './src/engine/careers.js', './src/engine/chemistry.js', './src/engine/scouting.js', './src/engine/jobs.js', './src/data/rookie-names.js', './src/slots.js', './src/engine/share.js', './src/ui/share-card.js', './src/data/names.js', './src/data/tuning.js',
  ...
  './src/ui/views/players.js', './src/ui/views/settings.js', './src/ui/views/career.js', './src/ui/views/auction.js', './src/ui/views/moves.js', './src/ui/views/offseason.js',
