...
**What is still out: 5 of 44, and four of them are one thing.** Third-down attempts 10.9 (real 11–16), punts 3.21 (3.5–5.5), field-goal attempts 1.45 (1.5–2.5) and TD : FG 2.05 (1.3–1.8) are not four findings but one: drives do not stall often enough. First downs come at 21.3 and third downs convert at 43.9%, both at the top of their ranges, so the chains move, third downs are rare, punts are rare, and a drive that reaches scoring range finishes rather than settling for three. The fifth, yards per completion 12.11 against 10.8–12.0, is a separate and much smaller matter — the completion distribution is a yard long in the middle (p50 10 against a real 9) rather than fat in the tail. Fixing the stall cluster means making it harder to move the chains, which moves scoring, and that is a deliberate piece of work rather than a knob, so it is recorded here.
