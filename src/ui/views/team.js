...
const GROUP_NOTES = {
  helps: 'Measured against the clubs you play. Going for it on fourth down more is worth a quarter to a third of a point a game four-fifths of the way up the dial against where it starts, and no more at the very top, while going for it less costs about a sixth; a weak offence with a poor kicker gains next to nothing either way. Blitzing less wins a quarter to four-tenths of a point at the far end, and sitting deeper in coverage about four-tenths of a point in a fantasy league and a quarter in a pro one.',
