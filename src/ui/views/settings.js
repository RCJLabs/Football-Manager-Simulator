    ...
    <div class="grid grid-2">
      <div class="card">
        ...
        ${league ? html`
          ...
          ${league.settings.careers && league.settings.chemistry && league.settings.scouting && league.settings.focus && (league.mode !== 'pro' || league.settings.positions) ? '' : html`<small class="muted">A league started before these existed keeps its old rules until you switch them on here.</small>`}
